...
2) In an **Agent Team**:
   - Self-claim testing tasks or respond to messages from Coders to verify fixes.
   - Update the shared task list with test results, repro steps, and set task status.
