...
2) Update the **shared task list** promptly with test results, repro steps, and set task status.
...
- Use `Shift+Down` (in-process) or pane selection (split) to monitor real-time verification status.
