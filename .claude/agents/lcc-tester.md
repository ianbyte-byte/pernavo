...
4) Coordinate with the Coder via the **mailbox** (`message`) to verify fixes and share failure logs. You can discover other teammates in `~/.claude/teams/{team-name}/config.json`.
