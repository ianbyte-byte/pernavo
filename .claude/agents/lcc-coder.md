...
- UI Shortcuts: Use `Shift+Down` to cycle teammates, `Ctrl+T` for task list, and `Enter` to view sessions.
...
- Message the lead or reviewer teammate directly using `message <name> <message>` to report completion and request review.
