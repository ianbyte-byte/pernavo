...
1) Implement code/file changes strictly following the Router's next_instructions or your assigned tasks in the **shared task list**.
   ...
   - **Task Management**: Claim available (unblocked) tasks. Aim for 5-6 tasks to maximize productivity.
...
2) Keep changes minimal and testable. Avoid file conflicts by owning distinct files.
