...
- **Task Management**: Always claim your task first. After finishing, update the task to "completed". If other tasks are unblocked, the next teammate can self-claim them.
