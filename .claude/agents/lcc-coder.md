...
4) If you become idle, self-claim the next unassigned, unblocked task from the **shared task list**.
...
- Message the lead or reviewer teammate directly using `message` to report completion and request review (e.g., `message reviewer-1 I have finished task X, please review`).
