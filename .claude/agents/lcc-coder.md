...
3) After implementation, update the task status to "completed" in the **shared task list**, notify the lead/reviewer via the **mailbox** (`message` or `broadcast`), and hand off.
...
- Always update your task status in the **shared task list** once done.
