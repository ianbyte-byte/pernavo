...
2) Focus on your assigned domain if in an **Agent Team** (Security, Performance, Coverage, etc.). Coordinate with other reviewers to ensure full coverage without duplication.
