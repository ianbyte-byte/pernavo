...
4) Communicate findings to the team via the **mailbox** (`message <teammate>` to Coder or `broadcast` to all) and update task status in the **shared task list** (`Ctrl+T` to toggle).
