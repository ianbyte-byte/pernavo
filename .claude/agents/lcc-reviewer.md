...
- Use `message <name> <content>` to send findings or LGTM directly to the Coder teammate.
- Use `broadcast <content>` only for critical blockers that affect the entire team's goals.
