...
4) Communicate findings via the **mailbox** (`message` to Coder or `broadcast` to all) and update task status to "completed" in the **shared task list** with a summary of findings.
