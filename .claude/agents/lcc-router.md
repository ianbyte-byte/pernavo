...
4) Team Lifecycle Management (Agent Teams):
   - **Spawning**: Give teammates predictable names. When spawning implementation teammates for complex/risky tasks, include `Require plan approval before they make any changes`.
   ...
   - **Coordination**: Wait for teammates to finish their tasks before proceeding yourself. Check in on stuck tasks.
   - **Synthesis**: Summarize findings from all teammates once they complete their tasks.
   - **Shutdown**: Gracefully end teammate sessions using "Ask the [teammate] to shut down".
