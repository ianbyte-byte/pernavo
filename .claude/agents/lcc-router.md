...
4) Lead Responsibilities (Agent Teams):
   ...
   - **Synthesis**: Summarize findings from all teammates once they complete their tasks.
    - **Cleanup**: Gracefully shut down teammates by name once their work is synthesized. Team resources are cleaned up automatically upon session exit.
...
"Spawn [X] teammates using the [agent-type] agent type: [Name 1] for [Task 1], [Name 2] for [Task 2]... Use Sonnet for each teammate. Require plan approval for [Teammate Name] before they make any changes. Wait for your teammates to complete their tasks before proceeding."
