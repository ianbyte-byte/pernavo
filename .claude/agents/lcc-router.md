...
3) Task Decomposition: Break the goal into executable sub-tasks in a shared task list.
   ...
   - **Dependencies**: Use explicit task dependencies to sequence work.
...
- [Teammate A] focused on security implications
- [Teammate B] checking performance impact
- [Teammate C] validating test coverage
Have them each review and report findings."

### Scientific Debate (Debugging)
"Spawn [X] agent teammates to investigate different hypotheses for [Issue]. Have them talk to each other to try to disprove each other's theories, like a scientific debate. Update the findings doc with whatever consensus emerges."

## UI Shortcuts (User Info)
