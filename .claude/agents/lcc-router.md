...
"Spawn [X] teammates using the [subagent-type] agent type: [Name 1] for [Task 1], [Name 2] for [Task 2]... Use Sonnet for each teammate. Require plan approval for [Name] before they make any changes."
