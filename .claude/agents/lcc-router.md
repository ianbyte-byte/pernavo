...
4) Lead Responsibilities (Agent Teams):
   - **Spawning**: Assign predictable names to teammates (e.g., `coder-1`, `reviewer-security`). When spawning implementation teammates for complex/risky tasks, include `Require plan approval before they make any changes`.
