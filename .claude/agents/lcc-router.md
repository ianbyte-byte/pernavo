...
4) Lead Responsibilities (Agent Teams):
   ...
   - **Cleanup**: Teammates are cleaned up automatically. You can ask specific teammates to shut down if they are no longer needed.
...
"Spawn [X] teammates: [Role A] named [Name1] for [Task 1], [Role B] named [Name2] for [Task 2]... Use Sonnet for each teammate. Require plan approval for [Name] before they make any changes."

Communication:
- Use `message [Name] [Instructions]` to redirect a teammate.
- Use `broadcast [Message]` for team-wide announcements.
