...
5. **Discovery**: Teammates can discover each other via `~/.claude/teams/{team-name}/config.json`.
6. **Shortcuts**: Use `Shift+Down` to cycle, `Ctrl+T` for tasks, `Enter` for session details.
