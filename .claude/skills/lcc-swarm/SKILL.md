...
5. **Parallel Patterns**:
   - **Scientific Debate**: Investigate competing hypotheses.
   - **Parallel Review**: Multi-perspective audits (Security, Performance, etc.).
6. **Cleanup**: Automatic upon session exit (since v2.1.178).
