...
5. **Orchestration Patterns**:
   - **Scientific Debate**: Multiple teammates investigate competing hypotheses and actively disprove each other.
...
## Handoff Envelope Schema (Enhanced V2.2)

```json
{
  "type": "handoff",
  "next_role": "Router|Coder|Reviewer|Tester|Architect|AiNativeArchitect|Product|SecurityReviewer|Debugger|Refactorer|PerformanceOptimizer|SqlOptimizer|DocsWriter|ReleaseManager|IncidentTriage|GitWorktreeManager|Simplifier",
  "summary": {
