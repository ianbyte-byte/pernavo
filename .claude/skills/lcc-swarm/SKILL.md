...
4. **Hooks**: Automated validation via `lcc-quality-gate.sh`. Errors must start with "Quality Gate:".
5. **Steering**: The lead monitors progress, approves plans, and performs a final synthesis before cleanup.
