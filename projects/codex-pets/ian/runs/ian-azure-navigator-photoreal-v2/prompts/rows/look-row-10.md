Create one horizontal look-direction strip for Codex pet `ian-azure-navigator`, atlas row 10.
...
IDENTITY LOCK — preserve Ian's long oval face, almond-shaped eyes, eyebrow-to-eye axis, natural eye spacing, nose bridge and tip, philtrum length, full lips, softly rounded jawline, and small viewer-left under-eye mole in every direction. This is a photoreal real-person likeness, never a generic idol, beauty-filter face, doll, figurine, short-faced character, or pointed-chin face. Keep copper-brown long hair, navy sailor styling, dark denim pinafore, and natural complete human anatomy from head to boots.
