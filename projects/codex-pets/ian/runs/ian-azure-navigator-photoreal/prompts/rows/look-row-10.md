...
PHOTOREAL IDENTITY LOCK: every pose is the same real human Ian with natural anatomy and head-to-body proportions, realistic skin, facial geometry, individual hair strands, fabric and footwear. No abstract, cartoon, anime, chibi, mascot, toy, doll, sticker, painted or cel-shaded rendering.
