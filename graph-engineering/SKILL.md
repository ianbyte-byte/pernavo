...
Compose reliable agent loops into the lightest explicit graph that the work justifies. Treat roles, edges, state, ownership, and exit tests as contracts rather than as an excuse to spawn more agents.
