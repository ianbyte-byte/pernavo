...
- **Cleanup**: Cleanup is automatic upon session exit. Resumed sessions keep their task list.
- **Display**: Supports `in-process` (agent panel) and split panes (`tmux`, `iterm2`).
