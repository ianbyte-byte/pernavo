...
- `engineering-work-system` — top-level orchestrator for the engineering work system, routes to the right sub-skill based on task type (reliability, review, architecture, release, incident response, continuous improvement)
