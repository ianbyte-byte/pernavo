Create Codex pet row `running-right` for `ao-denim-usagi`: exactly 8 full-body frames in one horizontal strip on flat pure green #00FF00.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: an original upright white bunny mascot, copper-orange forelock and ear-tip tufts, backward navy cap, navy denim overalls over a white puff-sleeve shirt, tiny light-blue knit cuff; youthful playful energy; animal face, no human likeness. Preserve silhouette, face, palette, material, proportions, markings, and props.
