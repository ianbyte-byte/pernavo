...
- **Cleanup**: Teammates can be shut down by name (e.g., "Ask the researcher teammate to shut down"). The team’s shared directories are cleaned up automatically when the session ends.
