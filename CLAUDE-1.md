...
- **Cleanup**: Teammates should be asked to shut down when their work is done. Team resources and configurations are cleaned up automatically when the lead session exits (v2.1.178+).
- **Parallel patterns**:
