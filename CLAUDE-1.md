...
- **Shared task list**: Use it to assign and track work. Teammates can self-claim tasks. Aim for 5-6 tasks per teammate to maximize productivity and allow for re-assignment.
...
- **Wait for Completion**: The lead must wait for teammates to finish their tasks before proceeding or performing synthesis.
- **Communication**:
