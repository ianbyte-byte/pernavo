...
- **Shared task list**: Use it to assign and track work. Teammates can self-claim tasks. Aim for 5-6 tasks per teammate to maximize productivity. Tasks have pending, in progress, and completed states.
...
- **TaskCreated**: Fires when a task is created. Rejects subjects < 10 characters or with 'TODO'.
