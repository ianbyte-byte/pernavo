...
- **Shared task list**: Use it to assign and track work. Teammates can self-claim unassigned, unblocked tasks. Aim for 5-6 tasks per teammate. Task status can sometimes lag; nudge teammates if stuck.
...
- **Context**: Teammates **do not inherit** the lead's conversation history. Provide rich, task-specific context in the spawn prompt.
- **Communication**:
...
- **Limitations**:
  ...
  - **Single Team**: One lead can only manage one team at a time.
- **Parallel patterns**:
